...
import com.Gzl0ng.team.domain.Architect;
import com.Gzl0ng.team.domain.Designer;
import com.Gzl0ng.team.domain.Employee;
import com.Gzl0ng.team.domain.Programmer;

/**
 * 
* @Description 用来开发团队成员的管理：添加，删除等。
* @author Gzl0ng Email:1329087835@qq.com
* @version
* @date 2021年5月13日下午4:35:30
*
 */
...
//			throw new TeamException("该员共正在休假，无法添加");
//		}
		switch (p.getStatus()){
			case BUSY:
				throw new TeamException("该成员已是某团队成员");
...
//		团队中至多只能有三名程序员
	...
	/**
	 * 
	* @Description 判断指定的员工是否已存在于已有的开发团队中
	* @author Gzl0ng
	* @date 2021年5月13日下午4:58:37
	* @param e
	* @return
	 */
	...
	/**
	 * 
	* @Description 将指定的员工从开发团队中删除
	* @author Gzl0ng
	* @date 2021年5月13日下午4:45:52
	* @param member
