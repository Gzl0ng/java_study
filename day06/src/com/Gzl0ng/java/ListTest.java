...
/**
 *  1.| ----Collection接口：单列结合，用来存储一个一个的对象
 ...
 *
 *          其中，Node定义为：Node定义为：体现了LinkedList的双向链表的说法
 ...
 *              }
 *          }
 *      4.Vector的源码分析：jdk7和jdk8中通过Vector（）构造器创建对象时，底层创建了长度为10的数组
 *        在扩容方面，默认扩容为原来的数组长度的2倍。
 * 面试题：ArrayList，LinkedList，Vector三者的异同？
 * 同：三个类都是实现了List接口，存储数据的特点相同：存储数据有序，可重复的数据
 * 不同：见上
 *
 *      5.List接口中的常用方法
 *
