 ...
 *
 *向Collection接口实现类的对象中添加数据obj时，要求所在类重写equals（）方法
 */
...
//        System.out.println(coll.contains(p));//true
        System.out.println(coll.contains(new Person("Jerry",20)));//false ->(重写Person中的equals方法后)true
