...
public class BufferTest {
    ...
    public void BufferedStreamTest() throws FileNotFoundException {
        ...
        try {
            ...
            File destFile = new File("彩虹六号3.jpg");
            //2.造流
            //2.1造节点流
...
//        fos.close();
    ...
    public void testCopyFileWithBufferd(){
        ...
        String destPath = "C:\\Users\\13290\\Desktop\\03-视频.mp4";

//        String srcPth = "hello.txt";
//        String destPath = "hello3.txt";

        copyFileWithBufferd(srcPth,destPath);

        long end = System.currentTimeMillis();

        System.out.println("复制操作花费的时间为：" + (end - start));//869
    }
