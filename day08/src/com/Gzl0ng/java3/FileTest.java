 ...
 * 3.后续File类的对象常会作为参数传递给流的构造器中，指明读取或者写入的“终点”。
 *
 *
 */
public class FileTest {
    ...
    public void test1() {
        ...
        File file2 = new File("E:\\IntelliJ_work\\JavaSenior\\day08\\he.txt");

        System.out.println(file1);
        System.out.println(file2);

        //构造器2
        File file3 = new File("E:\\IntelliJ_work", "JavaSenior");
...
public File[] listFiles() ：获取指定目录下的所有文件或者文件目录的File数组
    ...
    @Test
    public void test3(){
        File file = new File("E:\\IntelliJ_work\\JavaSenior");
